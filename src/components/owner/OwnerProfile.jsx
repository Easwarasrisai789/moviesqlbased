...
import OwnerNavbar from "./OwnerNavbar";  // Importing the OwnerNavbar component
import styled from "styled-components";

const OwnerProfile = () => {
  const [user, setUser] = useState({ name: "", email: "", phone: "", location: "" });
  ...
  return (
    <>
      <OwnerNavbar /> {/* Owner's Navbar */}
      <ProfileContainer>
        <ProfileCard>
          <Title>Owner Profile Details</Title>
          {loading ? (
